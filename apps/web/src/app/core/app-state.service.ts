...
import {
  ...
  VisualReference, Scene, PanelProposal, MangaPage, MangaAsset, CreatorProfile,
  ProjectPublishing, ChapterRelease, ChapterAnalytics, ChapterComment, ReaderBookmark
} from './models';
...
export class AppStateService implements OnInit, OnDestroy {
  ...
  // Bind this from AppComponent if needed
